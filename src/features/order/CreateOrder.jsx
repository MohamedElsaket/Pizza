      ...
      <Form method="POST" >
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {fromError?.phone && <p className="mt-2 rounded-md bg-red-100 p-2 text-xs text-red-700">{fromError.phone}</p>}
          </div>
        </div>
        ...
        <div>
          <input type="hidden" name="cart" value={JSON.stringify(cart)} onChange={() => {}} />
          <Button type='primary'>
